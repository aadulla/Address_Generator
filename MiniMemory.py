...
"""
"MiniMemory" corresponds to a contiguous subregion in the op_space of the current memory
"""
class MiniMemory:

    """
    "__init__" initializes the MiniMemory
    pararms:
    ...
    def __init__(self, offset, op_space_size, memory_size):
        ...
        self.backward_old_data_block = DataBlock(self.curr_op_space_start_ptr, self.memory_size)
        # datablock for old data that was indexed after curr_op_space_end_ptr
        self.forward_old_data_block = DataBlock(self.curr_op_space_end_ptr, self.memory_size)
