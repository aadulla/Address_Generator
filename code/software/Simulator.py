...
class Simulator:
    ...
    #     Weight_Memory and Output_Memory have full prefetches everytime so no need to worry about delta prefetches
    ...
    #     Input_Memory have both full and delta prefetches, so we need to analytically determine when a certain 
    #     prefetch scheme is used. When the lowest dim of an Input_Memory is "input", then there will always be
    ...
    #     a full prefetch. When the lowest dim on an Input_Memory is "channel", then there will never be a delta
