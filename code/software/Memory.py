...
class Memory:
    ...
    For instances of Weight_Memory and Output_Memory, there will always be positive delta prefetches
    where there is no possible reuse of data between successive prefetches (i.e. delta == op_space_size)

    For instances of Input_Memory, there will be a combination of positive and negative delta prefetches
...
"""
"Input_Memory" is a subclass of memory designed specifcally to interface with input data
"""
class Input_Memory(Memory):
    ...
    def __init__(self, 
        ...
        for i in range(num_mini_memories):
            self.mini_memory_lst.append(Mini_Memory(offsets[i], dim_1_size, self.memory_size))
...
class Weight_Memory(Memory):
    ...
    def __init__(self, 
        ...
        self.mini_memory_lst = []
        for i in range(num_mini_memories):
            self.mini_memory_lst.append(Mini_Memory(offsets[i], dim_2_size, self.memory_size))
